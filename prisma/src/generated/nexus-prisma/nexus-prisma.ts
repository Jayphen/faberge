...
export interface NexusPrismaTypes {
  ...
  inputTypes: {
    fields: {
      ...
      PlaceUpdateOneWithoutThingsInput: PlaceUpdateOneWithoutThingsInputInputObject
...
export interface ThingCreateInput {
  name?: string
  place?: PlaceCreateOneWithoutThingsInput | null
}
...
export interface ThingUpdateInput {
  name?: string | null
  place?: PlaceUpdateOneWithoutThingsInput | null
}
...
export interface PlaceUpdateOneWithoutThingsInput {
  create?: PlaceCreateWithoutThingsInput | null
...
export type PlaceUpdateOneWithoutThingsInputInputObject =
  | Extract<keyof PlaceUpdateOneWithoutThingsInput, string>
  | { name: 'create', alias?: string  } 
  | { name: 'update', alias?: string  } 
  | { name: 'upsert', alias?: string  } 
  | { name: 'delete', alias?: string  } 
